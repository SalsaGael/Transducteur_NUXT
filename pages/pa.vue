...
<div class="input-group mb-2">
    ...
    <input class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" id='pTC' type="number" v-bind:value="this.$store.state.pTC" @change="update('pTC', $event)"/>
    <div class="input-group-append">
...
<div class="input-group mb-2">
    ...
    <input class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" id='paMaxHT' type="number" v-bind:value="this.$store.state.paMaxHT" @change="update('paMaxHT', $event)"/>
    <div class="input-group-append">
...
<div class="input-group mb-2">
    ...
    <select id='smaMin' class="custom-select" v-bind:value="this.$store.state.smaMin" @change="update('smaMin', $event)">
    ...
    <select id='smaMax' class="custom-select" v-bind:value="this.$store.state.smaMax" @change="update('smaMax', $event)">
    <option value="5">5</option>
    <option value="10">10</option>
    <option value="20">20</option>
    </select>
